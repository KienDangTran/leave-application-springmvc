...
public enum View {
	...
	EMPLOYEE_DETAIL("maintainance_setup/employee/employeeDetails", "/WEB-INF/views/maintainance_setup/employee/employee-details.jsp");
	// @formatter:on
	
	private String viewName;
	private String viewUrl;
	
	private View(String viewName, String viewUrl) {
