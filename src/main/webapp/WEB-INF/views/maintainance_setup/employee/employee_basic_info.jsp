    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            ...
            <div class="btn-group pull-right">
                <button type="button" class="btn-lg btn-primary" ${readonly ? '' : 'hidden'}
                        onclick="enableEditing(currentEmployee)">
        ...
        <div class="panel-body">
            <fieldset>
                ...
                <div class="row">
                    <!-- Employee Code -->
                    <giong:form-input label="${i18n_employee_code}" path="employeeCode" identity="true" readonly="true"
                                      required="true" placeholder="${i18n_employee_code}"/>

                    <!-- Employee Name -->
                    <giong:form-input label="${i18n_employee_name}" path="employeeName" required="true"
                                      readonly="${readonly}" placeholder="${i18n_employee_name}"/>
                </div>

                <!-- Row 2 -->
                <div class="row">
                    <!-- Date of Birth -->
                    <giong:form-input path="dateOfBirth" type="date" readonly="${readonly}" required="true"
                                      label="${i18n_date_of_birth}" placeholder="${i18n_date_of_birth}"/>
                ...
                <div class="row">
                    <!-- Email -->
                    <giong:form-input label="${i18n_email}" path="email" type="email" placeholder="${i18n_email}"
                                      readonly="${readonly}"/>
            ...
            <div class="btn-group col-md-12">
                ...
                <button type="reset" id="btnCancel" class="btn-lg btn-primary pull-right" ${readonly ? 'hidden' : ''}
                        onclick="disableEditing(currentEmployee)">
...
<div class="btn-group btn-group-justified">
    ...
    <a class="btn btn-lg btn-primary modal-input-href" onclick="openConfirmationModal(this); return false;"
       rel="#confimationModal" rev="${removeEmployeeUlr}"
