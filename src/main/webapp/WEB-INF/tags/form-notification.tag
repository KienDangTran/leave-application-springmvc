...
<%@ attribute name="status" type="org.springframework.web.servlet.support.BindStatus"
              description="bind status (org.springframework.web.servlet.support.BindStatus)" %>
